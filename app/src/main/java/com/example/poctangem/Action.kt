...
class Action {
    ...
    fun scan() { GlobalScope.launch(Dispatchers.Main) {
    ...
    fun sign() { GlobalScope.launch(Dispatchers.Main) {
    ...
    fun purgeAllWallets() { GlobalScope.launch(Dispatchers.Main) {
    ...
    fun createAllWallets() { GlobalScope.launch(Dispatchers.Main) {
